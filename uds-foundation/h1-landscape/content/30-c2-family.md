...
illustration: figures/c2-family-map.svg
caption:
...
- {key} Swap the wire, keep the language — this is exactly the seam **SOVD** later widens.
:::
:::jp
...
- {key} 配線を替え、言語は保つ ― この継ぎ目こそ、後に **SOVD** が押し広げるものです。
:::
:::figure src=figures/c2-adapters.svg
...
:::
:::figure src=figures/c2-neighbours.svg
