...
:::en
Next, **H3** opens up the other side. If H2 followed one request through, H3 steps back and does three things: first it pins down what a **service** even *is* — the fixed shape behind the beat you just traced — then it lays out the ECU's whole **catalogue** of them, and finally shows *how it decides* to say yes or no.
:::
:::jp
次の **H3** は、反対側を開きます。H2が1つの要求を追ったなら、H3は一歩下がって3つのことをします ― まず**サービス**とは何かをはっきりさせ（今たどった1拍の裏にある、決まった「型」）、次にECUの**カタログ**全体を広げ、最後に*どうやって*イエス・ノーを決めるのかを見せます。
:::
